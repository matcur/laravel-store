...
export const siteDomain = 'http://store/';
...
import AddProductForm from './components/storage/products/Add-Product-Form'

Vue.component('order-form', OrderForm);
Vue.component('add-product-form', AddProductForm);
